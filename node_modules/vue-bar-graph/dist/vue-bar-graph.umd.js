...
/* harmony default export */ var VueBarGraphvue_type_script_lang_js_ = ({
    ...
    chartData: function chartData() {
      ...
      return this.dynamicPoints.map(function (dynamicValue, index) {
        return {
          ...
          yLabel: _this2.innerChartHeight + 4,
  ...
  methods: {
    ...
    tween: function tween(desiredDataArray) {
      ...
      Tween.to(initialData, this.animationDuration, _objectSpread({}, desiredData, {
